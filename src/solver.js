...
const TRIVIA_PATTERNS = [
  ...
  // Batch 4: High-frequency failures from logs (40+ patterns)
  { keywords: ['metal', 'steel', 'stainless steel'], answer: 'chromium' },
  { keywords: ['forest whitaker', 'oscar', '2006'], answer: 'the last king of scotland' },
  { keywords: ['inky', 'pinky', 'sue'], answer: 'clyde' },
  { keywords: ['longest reigning', 'british king'], answer: 'george iii' },
  { keywords: ['first man', 'walk on the moon'], answer: 'neil armstrong' },
  { keywords: ['henry viii', 'second wife'], answer: 'anne boleyn' },
  { keywords: ['when a man loves a woman', 'original'], answer: 'percy sledge' },
  { keywords: ['oldest person', 'number one hit', 'britain'], answer: 'tom jones' },
  { keywords: ['beatles', 'hard day\'s night', 'help'], answer: 'richard lester' },
  { keywords: ['volkswagen beetle', 'designed'], answer: 'ferdinand porsche' },
  { keywords: ['pink panther', 'theme', 'composed'], answer: 'henry mancini' },
  { keywords: ['piccadilly line', 'northern end'], answer: 'cockfosters' },
  { keywords: ['snooker', 'the grinder'], answer: 'cliff thorburn' },
  { keywords: ['taurus mountains', 'syria', 'iraq'], answer: 'euphrates' },
  { keywords: ['mineral', 'resistance', 'scratched'], answer: 'hardness' },
  { keywords: ['flag of gabon', 'yellow', 'green'], answer: 'blue' },
  { keywords: ['hemingway', 'newspaperman'], answer: 'jake barnes' },
  { keywords: ['roman calendar', 'second month'], answer: 'february' },
  { keywords: ['vincent eugene craddock', 'rockabilly', '1935'], answer: 'gene vincent' },
  { keywords: ['wet wet wet', '1994', 'biggest selling'], answer: 'love is all around' },
  { keywords: ['russia', 'annexe', 'ukraine', '2014'], answer: 'crimea' },
  { keywords: ['real love', '1996', 'last top 10'], answer: 'beatles' },
  { keywords: ['john', 'protest', '4 days', '25%'], answer: '9' },
